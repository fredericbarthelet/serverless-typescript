...
var getFunctionEventInterfaceName = function (func, serverless) {
    ...
    // a supprimer
    if ('/Users/Frederic/Sites/ratp-dev/dait/backend/services/networks-api/functions/app/create.ts' !==
        resolvedHandlerFile) {
        return;
    }
    ...
    serverless.cli.log("Found event interface " + interfaceName + " for function " + func);
...
exports.main = function (serverless) {
    ...
    var functionEventInterfaceNames = lodash_1.default.chain(httpFunctions)
        .map(function (func) {
        var functionEventInterfaceName = getFunctionEventInterfaceName(func, serverless);
